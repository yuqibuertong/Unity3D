...
public class getDuck : MonoBehaviour, IVirtualButtonEventHandler
{
    Material m;
    GameObject duck;
    GameObject button;
    ...
    void Start()
    {
        ...
        duck = transform.GetChild(0).gameObject;
    ...
    private void OnGUI()
    {
        ...
        GUI.Button(new Rect(0, 0, 500, 50), "FIND \"the TRUMAN show\"", gameStyle);
    }
