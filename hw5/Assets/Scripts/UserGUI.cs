...
public class UserGUI : MonoBehaviour {
	...
	void OnGUI() {
        ...
        if (isStart) {
            ...
            GUI.Label(new Rect(10, 95, 200, 50), "MODE", textStyle);
            ...
            if (act.getMode() == 0) GUI.Label(new Rect(200, 95, 200, 50), "ORIGIN", scoreStyle);
            else GUI.Label(new Rect(200, 95, 200, 50), "PHYSICS", scoreStyle);
