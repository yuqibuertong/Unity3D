...
namespace game {
    ...
    public class BankController {
        ...
        public ICharacterController findCharacter(int type) {
            for (int i = 0; i <roles.Length; i++)
                if (roles[i] != null && roles[i].type == type) {
                    ICharacterController temp = roles[i];
                    return temp;
                }
            return null;
        }
	...
	public class BoatController {
        ...
        public ICharacterController[] getRoles() {
            return roles;
        }
    }
